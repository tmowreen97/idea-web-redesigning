      ...
      <div>
        ...
        <div className="font-light">
          ...
          <div className="items-center justify-center flex">
            <h1 className="text-dark_text bg-light_bg rounded-xl p-4 m-10 text-6xl">Engineering Services</h1>
          </div>
          {/* Subsections*/}
          <div className="xl:grid xl:grid-cols-3 gap-10 mx-[5%] justify-center">
            {engineering_services.map((service)=> {
              return(
                <div className="flex justify-center text-dark_text p-5  rounded-xl" style={{backgroundColor: `${service.color}`}}>
                  <div className="justify-center">
                    <div className="items-center justify-center flex">
                      <h1 className="text-3xl p-5">{service.title}</h1>
                    </div>
                    <div className="w-[450px] flex justify-center rounded-xl p-5 shadow-inner font-medium" style={{backgroundColor: `${service.list_color}`}}>
        ...
        <div className="xl:grid xl:grid-cols-2 gap-10 mx-[5%] justify-center font-light">
          {/* Life Cycle */}
          <div className=" flex justify-center items-center">
            <div className="justify-center items-center ">
              <div className="items-center justify-center flex">
                <h1 className="text-dark_text bg-light_bg rounded-xl p-4 m-10 my-14 text-6xl text-center">{life_cycle_services.title}</h1>
              </div>
              <div className="flex justify-center xl:h-[550px] rounded-xl mx-10" style={{backgroundColor: `${life_cycle_services.color}`}}>
          ...
          <div className=" flex justify-center">
            <div className="justify-center items-center ">
              <div className="items-center justify-center flex">
                <h1 className="text-dark_text bg-light_bg rounded-xl p-4 m-10 text-6xl text-center">{construction_services.title}</h1>
              </div>
              <div className="flex justify-center xl:h-[550px] rounded-xl mx-10 p-5" style={{backgroundColor: `${construction_services.color}`}}>
