    ...
    <div className="main-image-container">
      <motion.div 
        ...
        <div className="image-container">
          {setIsClient ? 
          <>
          <Image className="image-before slider-image" src={'/assets/MSC/before-new-2025.jpg'} alt={'Before Image'} width={1800} height={800}/>
          <Image className="image-after slider-image" src={'/assets/MSC/after-new-2025.jpg'} alt={'After Image'} width={1800} height={800}/>      
