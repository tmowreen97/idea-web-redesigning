      ...
      <div className='w-screen  m-auto flex justify-between items-center p-3 text-white ml-1'>
        ...
        >
          ...
          <div className='flex justify-evenly '>
              <Image src={'/assets/clip-1.png'} width={70} height={70} className="m-1 my-3" alt={'icon'}/>
              <Image src={'/assets/clip-2.png'} width={60} height={60} className="m-1" alt={'icon'}/>
              <Image src={'/assets/clip-3.png'} width={60} height={60} className="m-1" alt={'icon'}/>
              <Image src={'/assets/clip-4.png'} width={60} height={60} className="m-1" alt={'icon'}/>
