...
function Hero({heading}){
  ...
  const blinkers = [
    ...
    },
    {
      ...
      div_parent_class: "absolute bottom-[131%] ml-[-35%] w-[350px]",
    ...
    },
    {
      ...
      div_parent_class: "absolute bottom-[-100%] right-[55%] w-[300px]",
    ...
    },
    {
      ...
      svg_class: "relative rotate-90 right-[90%]",
      poly_points: "10,0 200,200",
      div_parent_class: "absolute top-[30%] right-[140%] w-[375px]",
      heading: 'Shore Power',
      img: '/assets/clip-2.png',
    ...
    <div className='flex items-center justify-center h-screen w-screen pb-16 bg-center bg-cover custom-img'>
      <div className=" mb-40 md:mb-0 ">
        ...
        <div className="text-center justify-center items-center flex">
          ...
          >
            <button className={animate ? "bg-light_bg ease-in-out duration-200 p-2 rounded-xl animation-blimp-1 m-auto" : "bg-accent_1 text-primary_text ease-in-out duration-200 p-2 rounded-xl"} onClick={()=> handleMobileAnimate()}>
