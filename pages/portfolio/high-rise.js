...
export default function HighRise(){
  ...
  const projects = [
      // ALCOVE- Nashville, TN NEED IMAGE ??
      {
        ...
        child: 'lg:col-start-1 lg:col-end-3 lg:row-start-1 lg:row-end-3 w-full col-span-2'
      ...
      // 3025 JFK BLVD in Schuylkill Yards NEED IMAGE ??
      {
        ...
        height: '600',
        disclaimer: "*Project performed by IDEA team member at previous employment.",
        child: 'lg:col-start-3 lg:col-end-5 lg:row-start-1 lg:row-end-2 w-full col-span-2'
        // custom: ' w-[700px] max-w-[900px] h-full rounded-lg'
      },
      // 545 North Broad ST NEED IMAGE ??
      {
        ...
        height: '600',
        disclaimer: "*Project performed by IDEA team member at previous employment.",
        child: 'lg:col-start-3 lg:col-end-5 lg:row-start-2 lg:row-end-3 w-full col-span-2',
        // custom: ' w-[700px] max-w-[900px] h-full rounded-lg'
      },
      // 801 Church Street - Nashville, TN NEED IMAGE ?? 
      {
        ...
        height: '600',
        disclaimer: "*Project performed by IDEA team member at previous employment.",
        child: 'lg:col-start-1 lg:col-end-3 lg:row-start-3 lg:row-end-4 w-full col-span-2'
        // custom: ' w-[700px] max-w-[900px] h-full rounded-lg'
      },
      // 838 WEST END AVE UNSURE IF IMAGE IS APPROVED
      {
        ...
        child: 'lg:col-start-3 lg:col-end-5 lg:row-start-3 lg:row-end-5 w-full col-span-2'
        // child: 'lg:col-start-1 lg:col-end-5 flex justify-center',
        // custom: ' w-[700px] max-w-[900px] h-full rounded-lg'
      },
